...
public class PaymentServiceImplTest {
    ...
    public void testProcessPayment_Success() {
        ...
        // 3. Verify
        assertTrue(result);
        verify(walletService).deductBalance("user1", 50.0, "Tesco");
    }
    ...
    public void testProcessQRPayment_Success() {
        ...
        // 2. Execute
        boolean result = paymentService.processQRPayment("user1", "KFC:25.00");

        // 3. Verify
        assertTrue(result);
        verify(walletService).deductBalance("user1", 25.00, "QR: KFC");
    }
}